  ...
  content: (
    <div className="space-y-6 text-gray-700 leading-relaxed">
      ...
      <div className="flex gap-4 mt-6">
        <a href={whatsappLink('Hi SkydeepGroup! I want to book a Premium/Luxury car.')} target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white font-bold py-3 px-8 rounded-xl hover:shadow-lg hover:scale-105 transition-all w-full text-center">
