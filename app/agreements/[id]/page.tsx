    ...
    <div className="min-h-screen bg-gray-100 flex py-12 md:py-16 justify-center overflow-x-hidden print:bg-white print:py-0">
      ...
      <div className="w-full max-w-[800px] bg-white text-black shadow-2xl p-8 md:p-14 print:shadow-none print:w-[100%] print:max-w-none print:p-0">
        ...
        <div className="flex justify-between items-start border-b-2 border-gray-900 pb-6 mb-8">
           <div>
              <h1 className="text-3xl font-black uppercase tracking-tighter text-[#0B1F3A]">{COMPANY_NAME}</h1>
              <p className="text-[10px] uppercase tracking-widest text-[#E89B10] font-bold mt-1">Car Rental Agreement</p>
           </div>
           <div className="text-right text-xs text-gray-600 space-y-1">
              <p className="font-bold text-gray-900 uppercase">Self Drive Rentals</p>
              <p>{COMPANY_ADDRESS}</p>
              <p>Ph: +91 {COMPANY_PHONE}</p>
           </div>
        </div>
        ...
        <div className="mb-10">
           ...
           <table className="w-full text-sm text-left border-collapse border border-gray-200">
              ...
              <tbody>
                 <tr>
                    <td className="border border-gray-200 p-3 font-bold">{agreement.cars?.name || 'Unknown Vehicle'}</td>
           ...
           <div className="flex justify-end mt-4">
              <div className="w-64 space-y-2">
                 ...
                 <div className="border-t border-gray-900 pt-2 flex justify-between">
                    <span className="font-black uppercase">Total Payable:</span>
        ...
        <div className="mb-12">
            ...
            <div className="text-xs text-gray-700 space-y-2 leading-relaxed text-justify">
               <p>1. The customer confirms that they hold a valid unexpired driving license and are of legal age to drive locally.</p>
               <p>2. The rented vehicle must be returned with the exact fuel level as supplied. Refueling charges will apply if lower.</p>
               <p>3. The security deposit acts as collateral and will be refunded upon the safe return of the vehicle. Deductions apply in the event of new scratches, dents, missing parts, or unnotified traffic fines.</p>
               <p>4. In the event of an accident or major damage, the customer agrees to bear repair costs up to the maximum liability discussed, or the full cost if driving under the influence or racing.</p>
               <p>5. Late return without prior continuous approval will incur an hourly penalty fee of standard rates as per SkydeepGroup rules.</p>
            </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 mt-16 pt-8 border-t-2 border-gray-200">
           ...
           <div className="text-center">
              <div className="h-24 flex items-end justify-center border-b border-gray-300 pb-2">
                 <span className="font-script text-3xl opacity-50 block transform -rotate-6">SkydeepGroup</span>
              </div>
